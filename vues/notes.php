                ...
                <div class="competence">
                    ...
                    <div class="notes">
                        ...
                        foreach (getAllModsOfComp($comp["id_competence"]) as $mod) { ?>
                            <div class="title"><button class="developMod" id="<?php echo $mod["id_module"] ?>">
                            ...
                            <div class="devoirs data<?php echo $mod["id_module"] ?>">
                                <?php 
                                foreach (getAllDevoirsOfMod($mod["id_module"], $_SESSION["login"])->fetchAll(PDO::FETCH_ASSOC) as $devoir) { ?>
                                <div class="title noteDevoir"><h4><?php echo $devoir["nom_devoir"]; ?></h4><p><?php echo formatNote($devoir["valeur"]); ?></p></div>
                                <?php } ?>
                            </div>
                        <?php } ?>
                    </div>
